...
(5, 3, 'Helou', 'Já jsem vanilka', '<h1><span style=\"font-size: 36pt; background-color: rgb(185, 106, 217);\"><span style=\"font-family: \'comic sans ms\', sans-serif;\">J&aacute; jsem vanilka</span></span></h1>\r\n<pre><span style=\"font-size: 36pt;\">J&aacute; jsem vanilkaJ&aacute; js</span></pre>\r\n<nav class=\"navbar navbar-expand-lg\">', '2022-11-11 11:00:52', 'https://vignette2.wikia.nocookie.net/nekopara/images/7/7e/Vanilla_NEKOPARA_Vol_1_Artwork_8.jpg/revision/latest?cb=20151225181601', 1),
...
INSERT INTO `users` (`id`, `mail`, `password`, `name`, `surname`, `role`, `active`) VALUES
                                                                                        (3, 'admin@nekonews.com', '$2y$10$Vq7mv4fNL4kEjIJtHIsz4eeNRcMWVI2wjHr/Y9vgW3avnHi1WTs6K', 'Admin', 'Admin', 'admin', 1),
                                                                                        (4, 'jenda@gmail.com', '$2y$10$Ch0K2Yd4yyZ3e8nF/Y7UAeVV86dxmy1hlqlZarhyDGndBfUGojynC', 'Jenda', 'Adnej', 'editor', 1);
